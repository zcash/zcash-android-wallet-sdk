//! JNI exports for EIP-681 transaction request parsing (Kotlin's `RustEip681Tool`).
//!
//! The pure parsing/formatting logic lives in [`crate::eip681`]; the `JniEip681TransactionRequest`
//! marshalling this surface needs is small enough to live here beside the two exports it serves.
